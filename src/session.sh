...
VARIABLES="${VARIABLES} SDL_VIDEODRIVER QT_QPA_PLATFORM MOZ_ENABLE_WAYLAND _JAVA_AWT_WM_NONREPARENTING QT_STYLE_OVERRIDE ADW_DISABLE_PORTAL QT_QPA_PLATFORMTHEME"
